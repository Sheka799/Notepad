    ...
    return (
        <>
            {isLoading ? 
                <Loader /> : 
                <div className="p-4">
                    <Link href={`/edit/${id}`} className="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-sm font-medium text-red-700 ring-1 ring-red-600/10 ring-inset">Редактировать</Link>
